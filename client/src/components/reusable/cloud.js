...
export const Cloud = (props) => (
  <div className="cloud">
    <h2>{props.points || ""}</h2>
    <svg id="cloud" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 28.884 20.883" >
      <defs>
        <filter id="blurMe">
          <feGaussianBlur in="SourceGraphic" stdDeviation="1" />
        </filter>
      </defs>
      <path filter="url(#blurMe)"
        fill={props.fill || 'rgba(0,0,0, 0.4)'}
        d="M24.91,6.899c-0.385-3.056-2.963-5.427-6.118-5.427c-1.509,0-2.872,0.559-3.945,1.453c-1.011-1.29-2.565-2.137-4.33-2.137
